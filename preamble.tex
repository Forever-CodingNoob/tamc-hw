...
\usepackage[noend]{algpseudocode} % Environment for specifying algorithms in a natural way
\algdef{SE}[Indent]{Indent}{EndIndent}{}{}
\algtext*{Indent}
\algtext*{EndIndent}
\makeatletter
\algnewcommand{\StatexIndent}[1]{\Statex \hskip\ALG@tlm #1}
\makeatother
