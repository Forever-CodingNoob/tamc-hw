...
\usepackage{bm} % cooler bold font \bm
\usepackage{nicematrix} % cooler matrices
...
\newcommand{\FS}{\mathop{\mathsf{FS}}} % Fiat-Shamir transform
\renewcommand{\Game}{\mathbf{\mathsf{G}}}
\newcommand{\Hyb}{\mathsf{Hyb}}
% 2. Functions/Algorithms in schemes
...
\newcommand{\com}{\mathsf{com}} % Sigma-protocol: commitment
\newcommand{\ch}{\mathsf{ch}} % Sigma-protocol: challenge
\newcommand{\resp}{\mathsf{resp}} % Sigma-protocol: response
\newcommand{\commit}{\mathsf{commit}} % Commitment scheme: commitment
\newcommand{\interact}[1]{\left<#1\right>} % interactive scheme: interact
